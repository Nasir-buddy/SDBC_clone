      ...
      <div className='w-full flex'>
        ...
        <div className='content ml-10'>
          ...
          <h1 className='text-5xl font-black text-white'>
            ...
            <small className='text-2xl ml-3 font-bold text-zinc-300'>{info.details.first_air_date.split('-')[0]}</small>
          </h1>
          ...
          <h1 className='text-xl mt-5 text-white mb-3'>tv Translated</h1>
